...
(() => {
    ...
    function processMailSuccess(result) {
        ...
        if(result.name === "* Full name is required") {
            const name = document.querySelector("#name");
            name.placeholder = "* Full name is required";
        } 

        if(result.email === "* Email is required") {
            const email = document.querySelector("#email");
            email.placeholder = "* Email is required";
        } else if(result.email === "* Email is not valid") {
            const email = document.querySelector("#email");
            email.placeholder = "* Email is not valid";

        }
        // if(result.captcha === "Captcha is required" || result.captcha === "Captcha is not valid") {
